...
export class MessageTranslateService extends BaseService {
  ...
  async getTranslateByMessageId(messageId: string): ServiceResult<MessageTranslateResponse | null> {
    // Permission check has been completed at the route layer (MESSAGE_READ + TRANSLATION_READ)
  ...
  async translateMessage(
    ...
    // Permission check has been completed at the route layer (MESSAGE_READ + TRANSLATION_CREATE)
    ...
    try {
      // First get the original message content and sessionId
  ...
  async updateTranslateInfo(
    ...
    // Permission check has been completed at the route layer (MESSAGE_UPDATE + TRANSLATION_UPDATE)
  ...
  async deleteTranslateByMessageId(
    ...
    // Permission check has been completed at the route layer (TRANSLATION_DELETE)
